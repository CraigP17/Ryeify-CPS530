...
<div id="goto" class="row mt-5 pt-5">
    ...
    <div class="col-sm">
        <div class="card">
            ...
            <div class="card-body">
                <h5 class="card-title text-black">Personalized Spotify</h5>
    ...
    <div class="col-sm">
        <div class="card">
            ...
            <div class="card-body">
                <h5 class="card-title text-black">Trending Music</h5>
...
<div id="goto" class="row mt-5 pt-5" data-aos="fade-up" data-aos-duration="1000">
    ...
    <div class="col-sm">
        <div class="card">
            ...
            <div class="card-body">
                <h5 class="card-title text-black">Lyric Search</h5>
    ...
    <div class="col-sm">
        <div class="card">
            ...
            <div class="card-body">
                <h5 class="card-title text-black">Study Music</h5>
...
<div id="goto" class="row mt-5 pt-5" data-aos="fade-up" data-aos-duration="1000">
    ...
    <div class="col-sm">
        <div class="card">
            ...
            <div class="card-body">
                <h5 class="card-title text-black">Midi Piano</h5>
